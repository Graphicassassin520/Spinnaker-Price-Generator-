document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateFinancialDetails(resort, roomSize, ownershipType, salePrice) {
        ...
        if (selectedData) {
            ...
            document.getElementById('payment-terms').textContent = `Payment Terms: ${selectedData.paymentTerms}`;
            document.getElementById('maintenance-fee').textContent = `Maintenance Fee: ${selectedData.maintenanceFee}`;
        } else {
